	...
	export default {		data() {			return {
		...
		methods: {
			go_reset_pass:function(){
				var self=this;
				user.user_modify_pass(self.pass,self.pass1,self.pass2,function(res) {
